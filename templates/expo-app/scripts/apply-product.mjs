...
function main() {
  ...
  const design = readJson(join(project, 'design', 'design.json'));
  ...
  const product = {
    ...
    primaryColor: design.tokens.color_primary,
    backgroundColor: design.tokens.color_bg,
  };
 ...
 *
 * Written by \`scripts/apply-product.mjs\` from the design spec's tokens.
 * Editing this file directly means the next pipeline run overwrites your work.
 */

export const tokens = {
  colorPrimary: '${tokens.color_primary}',
  colorBg: '${tokens.color_bg}',
  colorSurface: '${tokens.color_surface}',
  colorText: '${tokens.color_text}',
  colorMuted: '${tokens.color_muted}',
  colorDanger: '${tokens.color_danger}',
  radius: ${tokens.radius},
  spacingUnit: ${tokens.spacing_unit},
